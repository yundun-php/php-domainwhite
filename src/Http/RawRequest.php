...
namespace DomainWhiteSdk\Http;

use DomainWhiteSdk\Exceptions\RawRequestException;
    ...
    public function setUrl($url)
    {
        ...
        if (false !== stripos($url, 'http://') || false !== stripos($url, 'https://')) {
            ...
            if (empty($this->base_api_url)) {
                throw new RawRequestException(RawRequestException::MSG_API_URL, RawRequestException::CODE_API_URL);
            }
